  ...
  return (
    ...
    className='relative min-h-[500px] lg:px-0 px-5 -my-10'>
      <div className='text-center'>
        <p className='flex text-2xl font-bold lg:w-[500px] w-[346px] lg:ml-[700px] md:ml-60 ml-5 md:mx-52 sm:mx-32 '>
            Features for a better experience
        </p>
      </div>
        
        <div className='flex lg:flex-row flex-col items-center text-center lg:items-center justify-start -ml-0 lg:ml-52 mt-10'>
